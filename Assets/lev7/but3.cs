...
public class but3 : MonoBehaviour
{
    ...
    public void cheak()
    {
        if (rightIsIt1 && rightIsIt2 && rightIsIt3 && rightIsIt4 && rightIsIt5 && rightIsIt6 && rightIsIt7)
        {
            scenrmann.colWork = 1;
            scenrmann.progres = 0;
            Debug.Log("Right");
    ...
    public void dagazF()
    {
        ...
        else if (letterCount == 7)
        {
            ...
            //dagaz2.transform.parent = this.transform;
            dagaz7.transform.position = new Vector3(Pos7.transform.position.x, Pos7.transform.position.y, 1);
    ...
    public void isaF()
    {
        ...
        else if (letterCount == 7)
        {
            ...
            //dagaz2.transform.parent = this.transform;
            isa7.transform.position = new Vector3(Pos7.transform.position.x, Pos7.transform.position.y, 1);
            isa7.SetActive(true);
        }
    }
    ...
    public void ansuzF()
    {
        ...
        else if (letterCount == 7)
        {
            ...
            //dagaz2.transform.parent = this.transform;
            ansuz7.transform.position = new Vector3(Pos7.transform.position.x, Pos7.transform.position.y, 1);
    ...
    public void uruzF()
    {
        ...
        else if (letterCount == 7)
        {
            ...
            //dagaz2.transform.parent = this.transform;
            uruz7.transform.position = new Vector3(Pos7.transform.position.x, Pos7.transform.position.y, 1);
    ...
    public void laguzF()
    {
        ...
        else if (letterCount == 7)
        {
            ...
            //dagaz2.transform.parent = this.transform;
            laguz7.transform.position = new Vector3(Pos7.transform.position.x, Pos7.transform.position.y, 1);
    ...
    public void sowiloF()
    {
        ...
        else if (letterCount == 7)
        {
            ...
            //dagaz2.transform.parent = this.transform;
            sowilo7.transform.position = new Vector3(Pos7.transform.position.x, Pos7.transform.position.y, 1);
    ...
    public void ingwazF()
    {
        ...
        else if (letterCount == 7)
        {
            ...
            //dagaz2.transform.parent = this.transform;
            ingwaz7.transform.position = new Vector3(Pos7.transform.position.x, Pos7.transform.position.y, 1);
    ...
    public void othilaF()
    {
        ...
        else if (letterCount == 7)
        {
            ...
            //dagaz2.transform.parent = this.transform;
            othila7.transform.position = new Vector3(Pos7.transform.position.x, Pos7.transform.position.y, 1);
    ...
    public void perthroF()
    {
        ...
        else if (letterCount == 7)
        {
            ...
            //dagaz2.transform.parent = this.transform;
            perthro7.transform.position = new Vector3(Pos7.transform.position.x, Pos7.transform.position.y, 1);
    ...
    public void raidhoF()
    {
        ...
        else if (letterCount == 7)
        {
            ...
            //dagaz2.transform.parent = this.transform;
            raidho7.transform.position = new Vector3(Pos7.transform.position.x, Pos7.transform.position.y, 1);
    ...
    public void tiwazF()
    {
        ...
        else if (letterCount == 7)
        {
            ...
            //dagaz2.transform.parent = this.transform;
            tiwaz7.transform.position = new Vector3(Pos7.transform.position.x, Pos7.transform.position.y, 1);
    ...
    public void eihwazF()
    {
        ...
        else if (letterCount == 7)
        {
            ...
            //dagaz2.transform.parent = this.transform;
            eihwaz7.transform.position = new Vector3(Pos7.transform.position.x, Pos7.transform.position.y, 1);
    ...
    public void jeraF()
    {
        ...
        else if (letterCount == 7)
        {
            ...
            //dagaz2.transform.parent = this.transform;
            jera7.transform.position = new Vector3(Pos7.transform.position.x, Pos7.transform.position.y, 1);
